...
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports JA_0_CS]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports JA_1_MOSI]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports JA_2_NC]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports JA_3_SCK]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports JA_4_DC]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports JA_5_RES]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports JA_6_VCCEN]
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports JA_7_PMODEN]
